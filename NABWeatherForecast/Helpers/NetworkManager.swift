...
//  NABWeatherForecast
//
//  Created by tringuyen3297 on 29/03/2022.
//
...
final class NetworkManager {
    ...
    func requestWeatherForecastInfo(with url: URL, completionHandler: @escaping (_ data: [DailyWeatherData], _ errorType: AppError?) -> Void) {
